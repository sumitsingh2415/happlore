...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Returns access + refresh tokens' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Send OTP to email or phone' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Refresh access token using a refresh token' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
